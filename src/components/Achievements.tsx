...
export const Achievements = () => {
  const { achievements, loading, getProgress } = useAchievements();
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-primary">{progress.unlocked}</span>
              <span className="text-muted-foreground">/ {progress.total}</span>
            </div>
            <p className="text-xs text-muted-foreground">{progress.percentage}% completat</p>
          </div>
        </div>
